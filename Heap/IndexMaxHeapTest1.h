...
#ifndef ALGORITHM_INDEXMAXHEAPTEST1_H
#define ALGORITHM_INDEXMAXHEAPTEST1_H
...
template<typename T>
void heapSortUsingIndexMaxHeap1(T arr[], int n){
...
void IndexMaxHeapTest1() {

    int n = 1000000;

    int* arr = SortTestHelper::generatorRandomArray(n, 0, n);
    SortTestHelper::testSort("Heap Sort Using Index-Max-Heap", heapSortUsingIndexMaxHeap1, arr, n);
    delete[] arr;

}
#endif //ALGORITHM_INDEXMAXHEAPTEST1_H
